...
<p align="center">
  <a href="https://nextjs.org/docs/pages/api-reference/components/image" target="_blank">
    <img alt="Next Image Optimization" src="https://img.shields.io/badge/Next Image-Remote Images-0.svg?style=flat-square&color=022ba7&labelColor=000000" />
  </a>
  ...
  <a href="https://nextjs.org/docs/pages/building-your-application/rendering/server-side-rendering" target="_blank">
  ...
  <a href="https://nextjs.org/docs/pages/building-your-application/rendering/static-site-generation" target="_blank">
...
<p align="center">
  ...
  <a href="https://developer.chrome.com/docs/lighthouse/overview/" target="_blank"><img alt="Light House" src="https://img.shields.io/badge/Light-House-0.svg?style=flat-square&color=e95632&labelColor=000000"></a>
</p>
...
> - <b>PWA</b> Service worker and offline cache
>
> ---
...
> ---
>
> - `dev` and `build` use Webpack explicitly because `next-pwa` still adds a Webpack config and Next.js 16 uses Turbopack by default.
> - The gallery loads APOD metadata in parallel, so the NASA API requests no longer run one by one.
>
> ---
